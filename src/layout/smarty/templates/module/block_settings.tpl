        ...
        {foreach $_configuration->config["solr"] AS $configuration=>$settings}
          <tr>
            ...
            <td rowspan="2">
              ...
              exampleFieldTextValues: {if isset($settings.exampleFieldTextValues) && is_array($settings.exampleFieldTextValues)}{implode(", ", $settings.exampleFieldTextValues)|escape:html}{else}---{/if}<br />
              ...
              exampleFieldIntegerValues: {if isset($settings.exampleFieldIntegerValues) && is_array($settings.exampleFieldIntegerValues)}{implode(", ",  $settings.exampleFieldIntegerValues)|escape:html}{else}---{/if}<br />
              ...
              exampleFieldStringValues: {if isset($settings.exampleFieldStringValues) && is_array($settings.exampleFieldStringValues)}{implode(", ",  $settings.exampleFieldStringValues)|escape:html}{else}---{/if}<br />
              ...
              exampleMtasPrefixWordValues: {if isset($settings.exampleMtasPrefixWordValues) && is_array($settings.exampleMtasPrefixWordValues)}{implode(", ",  $settings.exampleMtasPrefixWordValues)|escape:html}{else}---{/if}<br />
              ...
              exampleMtasPrefixLemmaValues: {if isset($settings.exampleMtasPrefixLemmaValues) && is_array($settings.exampleMtasPrefixLemmaValues)}{implode(", ",  $settings.exampleMtasPrefixLemmaValues)|escape:html}{else}---{/if}<br />
              ...
              exampleMtasPrefixPosValues: {if isset($settings.exampleMtasPrefixPosValues) && is_array($settings.exampleMtasPrefixPosValues)}{implode(", ",  $settings.exampleMtasPrefixPosValues)|escape:html}{else}---{/if}<br />
            </td>          
          </tr>
          <tr>
            <td>
